					...
					<form action="#" method="POST">
						...
						<div class="leaveForm">							
							...
							<div class="leaveForm_group">
								...
								<input type="text" name="from" class="leave_txt" placeholder="Leave Type Name" required="required">
							</div>						
						...
						<div class="btn_wrapper">
							<input type="submit" name="submit" value="Add Leave Type" class="emp_btn">
						</div>
					</form>
